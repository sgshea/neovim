...
local cmp_src_menu_items = {buffer = "buff", conjure = "conj", nvim_lsp = "lsp", path = "path", luasnip = "lsnp"}
_2amodule_locals_2a["cmp-src-menu-items"] = cmp_src_menu_items
local cmp_srcs = {{name = "nvim_lsp"}, {name = "conjure"}, {name = "luasnip"}, {name = "buffer"}, {name = "path"}, {name = "nvim_lua"}}
